...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        NSLayoutConstraint.activate([
            ...
            footnoteLabel.topAnchor.constraint(equalTo: deleteDescriptionLabel.bottomAnchor, constant: 30),
    ...
    func updateContent() {
        ...
        case .english:
            ...
            Congrats! You have successfully installed Yiddish Klal, a QWERTY-based keyboard for Standard Yiddish on iOS.
            ...
            • Tap shift (⇧) for alternate characters (or long-press on specific keys)
            • Tap "123" to access numbers and symbols
            
            The layout follows QWERTY positions for Latin/English. For detailed instructions and the full character map, visit:
            """
            ...
            deleteDescriptionLabel.textAlignment = .left
        ...
        case .yiddish:
            ...
            instructionsLabel.text = """
            מזל־טובֿ! איר האָט בהצלחה אינסטאַלירט די אַפּליקאַציע „ייִדיש כּלל", אַ QWERTY־קלאַװיאַטור אױף iOS פֿאַר די װאָס װילן אױסקלאַפּן טעקסטן לױטן אײנהײטלעכן ייִדישן אױסלײג („ייִװאָ־אױסלײג").
                        
            װי אַזױ צו דערמעגלעכן די קלאַװיאַטור:
            
            1. עפֿנט Settings אױף אײַער מאָבילקע
            2. גיט אַ קװעטש אױף
            ...
            • גיט אַ קװעטש אױף Shift (⇧) פֿאַר אַלטערנאַטיװן הינטער יעדן קלאַװיש (אָדער דריקט לאַנג אױף דעם קלאַװיש)
            ...
            deleteToggleLabel.textAlignment = .right
            deleteDescriptionLabel.text = "װען אָנגעצונדן (גרין): קװעטשן אױפֿן קריקקלאַװיש װעט אָפּמעקן אַ גאַנצן אות צוזאַמען מיט זײַנע דיאַקריטלעך (למשל: אַ). װען אױסגעלאָשן (גרױ): קװעטשן אױפֿן קריקקלאַװיש װעט קודם אָפּמעקן דאָס דיאַקריטל (אַ װערט א), דערנאָכדעם דעם אות גופֿא."
            deleteDescriptionLabel.textAlignment = .right
        }
    }
