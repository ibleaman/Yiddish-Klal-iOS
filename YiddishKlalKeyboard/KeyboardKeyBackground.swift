...
class KeyboardKeyBackground: UIView, Connectable {
    ...
    init(cornerRadius: CGFloat, underOffset: CGFloat) {
        self.attached = nil
        self.hideDirectionIsOpposite = false
        self.dirty = false
        ...
        self.startingPoints.reserveCapacity(4)
        self.segmentPoints.reserveCapacity(4)
        self.arcCenters.reserveCapacity(4)
        self.arcStartingAngles.reserveCapacity(4)
        
        for _ in 0..<4 {
            self.startingPoints.append(CGPoint.zero)
            self.segmentPoints.append((CGPoint.zero, CGPoint.zero))
            self.arcCenters.append(CGPoint.zero)
            self.arcStartingAngles.append(0)
        }
